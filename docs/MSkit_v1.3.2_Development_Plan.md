...
|------|------|
| 周期 | 6 周 |
| 主脚本 | Hide and Seek 实景对抗赛（组织/搜索/防护） |
| 备选脚本 | 野外搜救（组织/搜索，可选防护方安全区） |
| 可扩展说明 | 大型 Milsim 实景游戏、安保训练、灾害应急演练、越野定向/户外挑战赛、大型活动安保、工业/农林巡检、生态观察 |
| 硬件 | 方案 A：笔记本 + 无人机遥控器 + 无人机；方案 B：笔记本 + 无人机/离线素材导入 |
| 三方架构 | 组织方：组织者/裁判/调度；搜索方：搜索/搜救/巡检小队；防护方：防护/安保/值守小队 |
| 核心功能 | 组织方 定位态势/全局规划；搜索方 目标检测/变化检测；防护方 覆盖规划；三方地图态势展示；报告导出 |
