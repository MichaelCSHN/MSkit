...
| 文档 | 说明 |
|------|------|
| [MSkit_v1.3.2_MVP_Development_Plan.md](docs/MSkit_v1.3.2_MVP_Development_Plan.md) | **MVP PLAN（现阶段优先）**：6 周 M0 路演开发计划，聚焦 Hide and Seek 主脚本、野外搜救备选脚本、组织方 定位态势、搜索方 目标检测/变化检测、防护方 覆盖规划 |
...
| [MSkit_v1.3.2_MVP_Demo_Plan.md](docs/MSkit_v1.3.2_MVP_Demo_Plan.md) | **MVP 演示方案**：用于立项/融资路演，展示组织方 定位态势/规划、搜索方 目标检测/变化检测、防护方 覆盖规划 的三方闭环 |
